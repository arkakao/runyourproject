...
--
-- Host: localhost
-- Generation Time: Dec 1, 2019 at 09:02 PM
...
--
-- Database: `RunYourProject`
--
CREATE DATABASE IF NOT EXISTS `RunYourProject` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `RunYourProject`;
